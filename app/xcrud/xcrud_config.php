 ...
 * 
 *    N U O V A - V E R S I O N E
 * 
 *  */
class Xcrud_config
{
    // default connection
    public static $dbname = 'avisraccolta'; // Your database name
    ...
    // editor
    public static $editor_url = 'app/xcrud/editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $upload_folder_def = '/documenti'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
